execute if entity @e[type=witherstormmod:wither_storm,distance=..256] run effect give @s minecraft:mining_fatigue 1 0
execute if entity @e[type=witherstormmod:wither_storm,distance=512..] run effect give @s minecraft:slowness 1 1
execute if entity @e[type=witherstormmod:wither_storm,distance=..256] run effect give @s minecraft:weakness 1 1
